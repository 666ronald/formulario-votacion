...
-- Tiempo de generación: 07-06-2023 a las 07:54:56
...
INSERT INTO `regiones` (`id`, `name`, `ordinal_symbol`, `order`) VALUES
...
CREATE TABLE `votos` (
  ...
  `redes_sociales` int(11) NOT NULL DEFAULT '0',
  `amigo` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
--
ALTER TABLE `votos`
  MODIFY `idVoto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
